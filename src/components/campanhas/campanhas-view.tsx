...
export function CampanhasView({ data, platform }: CampanhasViewProps) {
  ...
  return (
    <>
      ...
      {/* Seção 5 — Rankings de Qualidade (Meta-only) */}
      {showRankings && (
        <div className="border-b border-border py-6">
          <h2
            className={cn(
